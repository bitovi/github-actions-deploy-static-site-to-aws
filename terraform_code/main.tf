...
resource "aws_cloudfront_distribution" "cdn_static_site" {
  ...
  aliases = [ var.aws_site_cdn_aliases != "" ? locals.parsed_aliases :  var.aws_r53_root_domain_deploy ? "${var.aws_r53_domain_name}" : "${var.aws_r53_sub_domain_name}.${var.aws_r53_domain_name}" ]
