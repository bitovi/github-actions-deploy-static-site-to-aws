...
locals {
  ...
  # Final URL Generator
  cdn_site_url = var.aws_spa_cdn_enabled ? ( local.selected_arn != "" ? aws_cloudfront_distribution.cdn_static_site[0].aliases : aws_cloudfront_distribution.cdn_static_site_default_cert[0].domain_name ) : ""
